...
import "./pages/calOverview";   // window.VOLO_CAL2.{Overview,Lens}
import "./pages/calCapture";    // window.VOLO_CAL2.{openCaptureModal,CaptureModal}（采集设置 · Profile CRUD，非实时采集会话）
